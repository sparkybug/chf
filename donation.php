      ...
      <div class="container">
        ...
        <div class="col-sm-5 mt-5">
                  <div class="card" style="opacity: 0.8;">
                    <div class="card-body">
                      <h1 class="card-title fs-1 fw-bolder">Others ways to give!</h1>
                      <p class="card-text">
                        <ul>
                          <li><a href="give.php#start_a_fund" class="fw-bold">Start a Fundraiser</a></li>
                          <li><a href="give.php#donate_stock" class="fw-bold">Donate stock</a></li>
                          <li><a href="give.php#donate_property" class="fw-bold">Donate your properties</a></li>
                        </ul>
                        <h5 class="card-title fs-4 fw-bold">How it Works</h5>
                        <ul class="fa-ul mt-5">
                            <li><i style="color:  #009788;" class="fa-li fa fa-asterisk"></i>Be a member by making a pertime donation or be on a monthly plan, and receive your full reward from God according to the total amount on your donation account .</li>
                            <li class="mt-2"><i style="color:  #009788;" class="fa-li fa fa-asterisk"></i> As a member you will keep receiving more referral bonuses, 15% on any amount of your referral donations. 
</li>
                            <li class="mt-2"><i style="color:  #009788;" class="fa-li fa fa fa-asterisk"></i>You can withdraw your referral bonuses once every week..</li>
                            
                            <li class="mt-2"><i style="color:  #009788;" class="fa-li fa fa fa-asterisk"></i>You get one time 5% bonus when you Give testimony.</li>
 

                        <div><br><em><blockquote>
                        Darkness can not be driven out by darkness but can only be conquered by light so transform lives by being a light to the people suffering in the darkness of poverty. Join us in this movement.</blockquote></em>
                        </div>
                      </p>
                    </div>
                  </div>
                    ...
                    <div class="row">
                        <div class="form-holder">
                            <div class="form-content pt-1 mr-2">
                              ...
                              <div class="col-md-12 col-sm-4">
                                  <input class="form-control" type="text" name="amount" placeholder="Amount to be Donated" required>
                              </div>

                                      <div class="form-button mt-3">
                                          <button type="submit" class="btn" name="submit"><a id="register">Donate</a></button>
