            ...
            <button id="menu-toggler" data-class="menu-active" class="hamburger">
              ...
              <span class="hamburger-line hamburger-line-bottom"></span>
                  ...
                  <ul id="primary-menu" class="menu nav-menu">
                    ...
                    <li class="menu-item "><a class="nav__link fw-bolder" id="join" href="signup.php">JOIN US</a></li>
                    <li class="menu-item "><a class="nav__link fw-bolder" id="login" href="login.php">LOGIN</a></li>
                  </ul>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-4 col-md-6 section-2-3">
        <div class="container pb-4"  style=" width: 80%;">
        <img src="./imgs/close-up-african-kids-reading-together.jpg" class="img-fluid mr-5 mt-5 mb-5 rounded mx-auto d-block" alt="...">
