...
and (-webkit-min-device-pixel-ratio: 2) {
  #image-head {
    ...
    <section>
    <div><img id="image-head" class="img-fluid w-100 img-bg" src="./imgs/connect.webp"  style="background-color: rgba(0, 0, 0, 0.8); " ><h2 class="bg-cap ">Contact Us</h2></div>
                ...
                <div class="text"><div class="decor-left"><span></span></div><p>Quick Contact</p><div class="decor-right"><span></span></div></div>
                    ...
                    <div class="contact-address-box row">
                        ...
                        <div class="col-sm-4 single-contact-address-box text-center">
                            ...
                            <h2>To give without any reward, or any notice, <br>has a special quality of its own.</h2>
                        </div>
                            ...
                            <div class="inner">
                                <ul>
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>
                                                Along Oko-afo Ilogbo Road, Old Nepa Office Opp Osyglad School foundation,<br> Ilogbo Lagos</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="title">
                        ...
                        <div class="col-sm-4 single-contact-address-box text-center">
                            ...
                            <h2>What do we live for if not to make life less<br> difficult for each other?</h2>
                        </div>
                        <!--End Single Contact Address Box-->
            </div>
        </div>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-sm-4 col-md-4"  style="margin-top: 100px;">
                      <img src="./imgs/covenant-footer.png" class="img-fluid">
                  </div>
              </div>
          </div>
