                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <!-- <th><input type="text" class="form-control" placeholder="Referral Code" disabled></th> -->
                                    <th><input type="text" class="form-control" placeholder="Total Donations" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Total Withdrawal" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                // }
                                    ...
                                    // echo "<td>" . $appointment['referlink'] . "</td>";
                                    // echo "<td>" . $appointment['refercount'] . "</td>";
                                    // echo "<td>" . $appointment['signupcode'] . "</td>";
