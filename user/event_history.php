...
<html lang="en">
    <head>
        ...
        <title>Welcome ADMIN <?php echo $userRow['fname'];?> <?php echo $userRow['lname'];?></title>
        <!-- Bootstrap Core CSS -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        <h3 class="panel-title">EVENTS HISTORY</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Events History" disabled></th>
                                    <!-- <th><input type="text" class="form-control" placeholder="Referral Count" disabled></th> -->
                                    <th><input type="text" class="form-control" placeholder="Event Date" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Event Time" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                // }
                                    ...
                                    echo "<td>" . $appointment['past_events'] . "</td>";
                                    // echo "<td>" . $appointment['refercount'] . "</td>";
                                    echo "<td>" . $appointment['past_event_date'] . "</td>";
                                    echo "<td>" . $appointment['past_event_time'] . "</td>";
                                    echo "<td>" . $appointment['Duration'] . "</td>";
