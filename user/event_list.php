                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Upcoming Events" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                // }
                                    ...
                                    echo "<td>" . $appointment['current_events'] . "</td>";
                                    // echo "<td>" . $appointment['refercount'] . "</td>";
                                    echo "<td>" . $appointment['current_event_date'] . "</td>";
                                    echo "<td>" . $appointment['current_event_time'] . "</td>";
