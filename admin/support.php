<?php 
    ...
    $res = mysqli_query($con, "SELECT * FROM adminTable WHERE adminUsername = '$usersession'");
...
<html lang="en">
    <head>
        ...
        <title>WELCOME ADMIN <?php echo $userRow['adminFname'];?> <?php echo $userRow['adminLname'];?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admindashboard.php">WELCOME ADMIN <?php echo $userRow['adminFname'];?> <?php echo $userRow['adminLname'];?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="donatelist.php"><i class="fa fa-fw fa-edit"></i> Donations</a>
                        </li>
                        <li>
                            <a href="volunteer_list.php"><i class="fa fa-fw fa-edit"></i> Volunteer List</a>
                        </li>
                        <li>
                            <a href="support.php"><i class="fa fa-fw fa-edit"></i> Support List</a>
                        </li>
                        <li>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Support Message" disabled></th>
                                    <!-- <th><input type="text" class="form-control" placeholder="Contact Preference" disabled></th> -->
                                </tr>
                            </thead>

                            <?php 
                            $res=mysqli_query($con,"SELECT `fname`, `lname`, `company`, `phone`, `email`, `smessage` FROM support");
                                  if (!$res) {
                                    printf("Error: %s\n", mysqli_error($con));
                                    exit();
                                }
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                // }
                                    ...
                                    echo "<td>" . $appointment['company'] . "</td>";
                                    echo "<td>" . $appointment['phone'] . "</td>";
                                    // echo "<td>" . $appointment['city'] . "</td>";
                                    // echo "<td>" . $appointment['state'] . "</td>";
                                    echo "<td>" . $appointment['email'] . "</td>";
                                    echo "<td>" . $appointment['smessage'] . "</td>";
                                    // echo "<td>" . $appointment['amount'] . "</td>";
