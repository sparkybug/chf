            ...
            <span class="hamburger-line hamburger-line-bottom"></span>
                ...
                <ul id="primary-menu" class="menu nav-menu">
                  ...
                  <li class="menu-item dropdown"><a class="nav__link" id="about" href="about.php">About Us</a>
                    <ul class="sub-nav" >
                        <li><a class="sub-nav__link" href="#">Mission </a></li>
                        <li><a class="sub-nav__link" href="#">Vision</li>
                        <li><a class="sub-nav__link" href="#">Our Causes</a></li>
                    </ul>
                    ...
                    <div class="form-items">
                        ...
                        <form action="" method="POST">
                          ...
                          <div class="form-button mt-3">
                              <!-- <button id="register" type="submit" class="btn">Login</button> -->
