        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $userRow['adminFname']; ?> <?php echo $userRow['adminLname']; ?><b class="caret"></b></a>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Amount Donated" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Amount Withdrawn" disabled></th>
                                    <!-- <th><input type="text" class="form-control" placeholder="Fname" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Lname" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                // }
                                    ...
                                    echo "<td>" . $appointment['withdrawn'] . "</td>";
